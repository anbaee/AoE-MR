...
def normalization(df):
    #'Volume', 'on_balance_volume','ADI', 'ATR'
    ...
    drop_list = ['Close', 'EMA', 'bb_bbl',   'on_balance_volume','bb_bbh', 'bb_bbm',  'stochastic',
                 'RSI', 'momentum', 'MACD', 'wiliams', 'bb_bbh', 'bb_bbm','Volume','ADI', 'ATR']
...
history, model = predictiveModel.baselineModelTrain(train_x, train_news_x,  train_y , validation_x, validation_news_x,  validation_y, problem='baseline3')
plot_loss(history)
