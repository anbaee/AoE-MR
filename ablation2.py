...
marketDF = pd.read_excel('data/USDJPYHourlyIndicators.xlsx')
df = pd.read_excel('data/USDJPYNewsSA.xlsx')
daily_marketDF = pd.read_excel('data/indicatorsUSDJPYdaily.xlsx')
...
def normalization(df):
    # 'ATR','Volume','ADI', 'on_balance_volume',
    df.drop(['High', 'Low', 'Open'], axis=1, inplace=True)
    drop_list = ['Close', 'EMA', 'bb_bbl',  'bb_bbh', 'bb_bbm',   'stochastic',
